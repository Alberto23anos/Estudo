...
CREATE DATABASE IF NOT EXISTS `north` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `north`;

-- Dumping structure for table north.categories
...
-- Dumping data for table north.categories: ~8 rows (approximately)
...
-- Dumping structure for table north.customers
...
-- Dumping data for table north.customers: ~91 rows (approximately)
...
-- Dumping structure for table north.employee
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  `photo_path` varchar(38) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table north.employee: ~9 rows (approximately)
/*!40000 ALTER TABLE `employee` DISABLE KEYS */;
INSERT INTO `employee` (`employee_id`, `last_name`, `first_name`, `title`, `title_of_courtesy`, `birth_date`, `hire_date`, `address`, `city`, `region`, `postal_code`, `country`, `home_phone`, `extension`, `photo`, `notes`, `reports_to`, `photo_path`) VALUES
	...
	(9, 'Dodsworth', 'Anne', 'Sales Representative', 'Ms.', '1966-01-27 00:00:00', '1994-11-15 00:00:00', '7 Houndstooth Rd.', 'London', NULL, 'WG2 7LT', 'UK', '(71) 555-4444', 452, NULL, 'Anne has a BA degree in English from St. Lawrence College.  She is fluent in French and German.', 5, 'http://accweb/emmployees/davolio.bmp');
/*!40000 ALTER TABLE `employee` ENABLE KEYS */;

-- Dumping structure for table north.employee_territories.
CREATE TABLE IF NOT EXISTS `employee_territories.` (
  `employee_id` bigint(20) DEFAULT NULL,
  `territory_id` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table north.employee_territories.: ~49 rows (approximately)
...
-- Dumping structure for table north.orders
CREATE TABLE IF NOT EXISTS `orders` (
  `order_id` bigint(20) DEFAULT NULL,
  `customer_id` varchar(7) DEFAULT NULL,
  `employee_id` bigint(20) DEFAULT NULL,
  `order_date` varchar(12) DEFAULT NULL,
  `required_date` varchar(12) DEFAULT NULL,
  `shipped_date` varchar(12) DEFAULT NULL,
  `ship_via` bigint(20) DEFAULT NULL,
  `freight` double DEFAULT NULL,
  `ship_name` varchar(36) DEFAULT NULL,
  `ship_address` varchar(48) DEFAULT NULL,
  `ship_city` varchar(17) DEFAULT NULL,
  `ship_region` varchar(15) DEFAULT NULL,
  `ship_postal_code` varchar(11) DEFAULT NULL,
  `ship_country` varchar(18) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table north.orders: ~830 rows (approximately)
...
-- Dumping structure for table north.order_details
...
-- Dumping data for table north.order_details: ~2 155 rows (approximately)
...
INSERT INTO `order_details` (`order_id`, `product_id`, `unit_price`, `quantity`, `discount`) VALUES
	...
	(10553, 31, 12.5, 30, 0),
	(10553, 35, 18, 6, 0),
	(10554, 16, 17.4, 30, 0.05),
	(10554, 23, 9, 20, 0.05),
	(10554, 62, 49.3, 20, 0.05),
	(10554, 77, 13, 10, 0.05),
	(10555, 14, 23.2, 30, 0.2),
	(10555, 19, 9.2, 35, 0.2),
	(10555, 24, 4.5, 18, 0.2),
	(10555, 51, 53, 20, 0.2),
	(10555, 56, 38, 40, 0.2),
	...
	(10570, 11, 21, 15, 0.05),
	(10570, 56, 38, 60, 0.05),
	(10571, 14, 23.2, 11, 0.15),
	(10571, 42, 14, 28, 0.15),
	(10572, 16, 17.4, 12, 0.1),
	(10572, 32, 32, 10, 0.1),
	(10572, 40, 18.4, 50, 0),
	(10572, 75, 7.8, 15, 0.1),
	(10573, 17, 39, 18, 0),
	...
	(10651, 22, 21, 20, 0.25),
	(10652, 30, 25.9, 2, 0.25),
	(10652, 42, 14, 20, 0),
	(10653, 16, 17.4, 30, 0.1),
	(10653, 60, 34, 20, 0.1),
	(10654, 4, 22, 12, 0.1),
	(10654, 39, 18, 20, 0.1),
	(10654, 54, 7.4, 6, 0.1),
	...
	(10697, 19, 9.2, 7, 0.25),
	(10697, 35, 18, 9, 0.25),
	(10697, 58, 13.2, 30, 0.25),
	(10697, 70, 15, 30, 0.25),
	(10698, 11, 21, 15, 0),
	(10698, 17, 39, 8, 0.05),
	(10698, 29, 123.8, 12, 0.05),
	(10698, 65, 21, 65, 0.05),
	(10698, 70, 15, 8, 0.05),
	(10699, 47, 9.5, 12, 0),
	(10700, 1, 18, 5, 0.2),
	...
	(10719, 30, 25.9, 3, 0.25),
	(10719, 54, 7.4, 40, 0.25),
	(10720, 35, 18, 21, 0),
	(10720, 71, 21.5, 8, 0),
	(10721, 44, 19.4, 50, 0.05),
	(10722, 2, 19, 3, 0),
	(10722, 31, 12.5, 50, 0),
	(10722, 68, 12.5, 45, 0),
	(10722, 75, 7.8, 42, 0),
	...
	(10749, 59, 55, 6, 0),
	(10749, 76, 18, 10, 0),
	(10750, 14, 23.2, 5, 0.15),
	(10750, 45, 9.5, 40, 0.15),
	(10750, 59, 55, 25, 0.15),
	(10751, 26, 31.2, 12, 0.1),
	(10751, 30, 25.9, 30, 0),
	(10751, 50, 16.2, 20, 0.1),
	(10751, 73, 15, 15, 0),
	(10752, 1, 18, 8, 0),
	(10752, 69, 36, 3, 0),
	(10753, 45, 9.5, 4, 0),
	...
	(10785, 75, 7.8, 10, 0),
	(10786, 8, 40, 30, 0.2),
	(10786, 30, 25.9, 15, 0.2),
	(10786, 75, 7.8, 42, 0.2),
	(10787, 2, 19, 15, 0.05),
	(10787, 29, 123.8, 20, 0.05),
	(10788, 19, 9.2, 50, 0.05),
	(10788, 75, 7.8, 40, 0.05),
	(10789, 18, 62.5, 30, 0),
	(10789, 35, 18, 15, 0),
	(10789, 63, 43.9, 30, 0),
	(10789, 68, 12.5, 18, 0),
	(10790, 7, 30, 3, 0.15),
	(10790, 56, 38, 20, 0.15),
	(10791, 29, 123.8, 14, 0.05),
	(10791, 41, 9.6, 20, 0.05),
	(10792, 2, 19, 10, 0),
	(10792, 54, 7.4, 3, 0),
	(10792, 68, 12.5, 15, 0),
	(10793, 41, 9.6, 14, 0),
	(10793, 52, 7, 8, 0),
	(10794, 14, 23.2, 15, 0.2),
	(10794, 54, 7.4, 6, 0.2),
	(10795, 16, 17.4, 65, 0),
	(10795, 17, 39, 35, 0.25),
	(10796, 26, 31.2, 21, 0.2),
	(10796, 44, 19.4, 10, 0),
	(10796, 64, 33.2, 35, 0.2),
	(10796, 69, 36, 24, 0.2),
	(10797, 11, 21, 20, 0),
	(10798, 62, 49.3, 2, 0),
	(10798, 72, 34.8, 10, 0),
	...
	(10800, 54, 7.4, 7, 0.1),
	(10801, 17, 39, 40, 0.25),
	(10801, 29, 123.8, 20, 0.25),
	(10802, 30, 25.9, 25, 0.25),
	(10802, 51, 53, 30, 0.25),
	(10802, 55, 24, 60, 0.25),
	...
	(10832, 13, 6, 3, 0.2),
	(10832, 25, 14, 10, 0.2),
	(10832, 44, 19.4, 16, 0.2),
	(10832, 64, 33.2, 3, 0),
	(10833, 7, 30, 20, 0.1),
	(10833, 31, 12.5, 9, 0.1),
	(10833, 53, 32.8, 9, 0.1),
	(10834, 29, 123.8, 8, 0.05),
	(10834, 30, 25.9, 20, 0.05),
	(10835, 59, 55, 15, 0),
	(10835, 77, 13, 2, 0.2),
	(10836, 22, 21, 52, 0),
	(10836, 35, 18, 6, 0),
	...
	(10856, 42, 14, 20, 0),
	(10857, 3, 10, 30, 0),
	(10857, 26, 31.2, 35, 0.25),
	(10857, 29, 123.8, 10, 0.25),
	(10858, 7, 30, 5, 0),
	(10858, 27, 43.9, 10, 0),
	(10858, 70, 15, 4, 0),
	(10859, 24, 4.5, 40, 0.25),
	(10859, 54, 7.4, 35, 0.25),
	(10859, 64, 33.2, 30, 0.25),
	(10860, 51, 53, 3, 0),
	(10860, 76, 18, 20, 0),
	(10861, 17, 39, 42, 0),
	(10861, 18, 62.5, 20, 0),
	...
	(10870, 51, 53, 2, 0),
	(10871, 6, 25, 50, 0.05),
	(10871, 16, 17.4, 12, 0.05),
	(10871, 17, 39, 16, 0.05),
	(10872, 55, 24, 10, 0.05),
	(10872, 62, 49.3, 20, 0.05),
	(10872, 64, 33.2, 15, 0.05),
	(10872, 65, 21, 21, 0.05),
	(10873, 21, 10, 20, 0),
	(10873, 28, 45.6, 3, 0),
	(10874, 10, 31, 10, 0),
	...
	(10930, 27, 43.9, 25, 0),
	(10930, 55, 24, 25, 0.2),
	(10930, 58, 13.2, 30, 0.2),
	(10931, 13, 6, 42, 0.15),
	(10931, 57, 19.5, 30, 0),
	(10932, 16, 17.4, 30, 0.1),
	...
	(10951, 41, 9.6, 6, 0.05),
	(10951, 75, 7.8, 50, 0.05),
	(10952, 6, 25, 16, 0.05),
	(10952, 28, 45.6, 2, 0),
	(10953, 20, 81, 50, 0.05),
	(10953, 31, 12.5, 50, 0.05),
	(10954, 16, 17.4, 28, 0.15),
	...
	(10991, 76, 18, 90, 0.2),
	(10992, 72, 34.8, 2, 0),
	(10993, 29, 123.8, 50, 0.25),
	(10993, 41, 9.6, 35, 0.25),
	(10994, 59, 55, 18, 0.05),
	(10995, 51, 53, 20, 0),
	(10995, 60, 34, 4, 0),
	(10996, 42, 14, 40, 0),
	...
	(11064, 55, 24, 4, 0.1),
	(11064, 68, 12.5, 55, 0),
	(11065, 30, 25.9, 4, 0.25),
	(11065, 54, 7.4, 20, 0.25),
	(11066, 16, 17.4, 3, 0),
	(11066, 19, 9.2, 42, 0),
	(11066, 34, 14, 35, 0),
	(11067, 41, 9.6, 9, 0),
	...
	(11073, 11, 21, 10, 0),
	(11073, 24, 4.5, 20, 0),
	(11074, 16, 17.4, 14, 0.05),
	(11075, 2, 19, 10, 0.15),
	(11075, 46, 12, 30, 0.15),
	(11075, 76, 18, 2, 0.15),
	(11076, 6, 25, 20, 0.25),
	(11076, 14, 23.2, 20, 0.25),
	...
	(11077, 12, 38, 2, 0.05),
	(11077, 13, 6, 4, 0),
	(11077, 14, 23.2, 1, 0.03),
	(11077, 16, 17.4, 2, 0.03),
	(11077, 20, 81, 1, 0.04),
	(11077, 23, 9, 2, 0),
	(11077, 32, 32, 1, 0),
	(11077, 39, 18, 2, 0.05),
...
-- Dumping structure for table north.products
CREATE TABLE IF NOT EXISTS `products` (
  `product_id` bigint(20) DEFAULT NULL,
  `product_name` varchar(33) DEFAULT NULL,
  ...
  `reorder_level` bigint(20) DEFAULT NULL,
  `discontinued` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table north.products: ~77 rows (approximately)
...
-- Dumping structure for table north.region
CREATE TABLE IF NOT EXISTS `region` (
  `region_id` bigint(20) DEFAULT NULL,
  `region_description` varchar(8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table north.region: ~4 rows (approximately)
...
-- Dumping structure for table north.shippers
CREATE TABLE IF NOT EXISTS `shippers` (
  `shipper_id` bigint(20) DEFAULT NULL,
  `company_name` varchar(17) DEFAULT NULL,
  `phone` varchar(14) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table north.shippers: ~6 rows (approximately)
...
-- Dumping structure for table north.suppliers
CREATE TABLE IF NOT EXISTS `suppliers` (
  `supplier_id` bigint(20) DEFAULT NULL,
  `company_name` varchar(38) DEFAULT NULL,
  `contact_name` varchar(26) DEFAULT NULL,
...
-- Dumping data for table north.suppliers: ~29 rows (approximately)
...
-- Dumping structure for table north.territories
CREATE TABLE IF NOT EXISTS `territories` (
  `territory_id` bigint(20) DEFAULT NULL,
  `territory_description` varchar(16) DEFAULT NULL,
  `region_id` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table north.territories: ~53 rows (approximately)
...
-- Dumping structure for table north.us_states
CREATE TABLE IF NOT EXISTS `us_states` (
  `state_id` bigint(20) DEFAULT NULL,
  `state_name` varchar(20) DEFAULT NULL,
  `state_abbr` varchar(2) DEFAULT NULL,
  `state_region` varchar(7) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table north.us_states: ~51 rows (approximately)
